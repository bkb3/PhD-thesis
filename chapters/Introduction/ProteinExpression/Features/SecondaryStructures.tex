...
If the region around translation initiation site forms a strong structure, this leads to disruption of the formation of initiation complex, which inhibits translation (Figure \ref{fig:sec_str_rbs}) \cite{Kudla2009-tl, Espah_Borujeni2014-vy, Tuller2015-ts}. Recent studies show that the RNA structure stability of this region explains protein variation better then codon usage \cite{Kudla2009-tl, Plotkin2011-ak, Cambray2018-kn} indicating that translation initiation is a rate limiting step in translation. Furthermore, secondary structure of the mRNA has been shown to change its functional half-life and thus regulate the protein expression \cite{mauger2019mrna}. Minimum free energy (MFE) of mRNA is widely used to measure the strength and stability of secondary structure. Combinatorial explosion occurs if we were to enumerate all possible structures of a given mRNA sequence in an attempt to finding the one with minimum free energy. However, dynamic programming has made this problem tractable the details of which is described below.
